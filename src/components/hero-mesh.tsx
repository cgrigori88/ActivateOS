 ...
 * sign-in gate — the one page every session starts on, often on a cold cache and
 * before anything is authenticated — is a bad trade for a background, so the
 * same form is projected by hand: a parametric torus, rotated, drawn as rings
 * and spines with additive compositing so overlapping strokes build brightness
 * the way the GL version's layered materials do.
 *
 * No external assets and no inline script, so it satisfies the strict CSP.
