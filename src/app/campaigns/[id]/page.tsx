      ...
      <Card className="mb-6">
        <div className="flex flex-wrap items-center gap-6">
          <div className="pos-bento">
            ...
            <div className="mt-1.5 text-[11.5px] font-semibold text-neutral-500">engagement score</div>
          </div>
          {[
            ...
            <div key={label as string} className="pos-bento">
              <div className="pos-bento-fig tnum text-[26px] font-extrabold leading-none tracking-[-0.03em]">{val as number}</div>
              <div className="mt-1.5 text-[11.5px] font-semibold text-neutral-500">{label as string}</div>
            </div>
          ))}
