...
**Last updated:** 2026-09-15 (H1B Gate 4 — PASS AFTER DOCUMENTED RE-BASELINE; certification fingerprint rule CFR-1 adopted; Gate 5 not begun)

**2026-09-15 (latest) — H1B GATE 4: PASS AFTER DOCUMENTED RE-BASELINE.** Owner decision: re-baseline (option a). The three render-created rows stay; they are not deleted.
