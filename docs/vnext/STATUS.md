...
**Last updated:** 2026-09-15 (H1B Gate 8 — PASS; rollback and restoration both proven; Preview back on `app_rw`; Gate 9 not begun)

**2026-09-15 (latest) — H1B GATE 8: PASS** (Phase 2, restoring `app_rw`: PASS).
