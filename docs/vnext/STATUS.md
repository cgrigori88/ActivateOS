...
**Last updated:** 2026-09-16 — **P45-1 HOSTED ACCEPTED / CLOSED. P45-D1 HOSTED CORRECTED / CLOSED.** P4's first governed actor + explicit capability grant and P5's first durable Pursuit execution are both **PROVEN HOSTED** through the real `app_rw` runtime (`d742a77` as `dpl_2syZQr94SCB2kyPpCs1vJN594BNV`). Synthetic fixture fully removed; **159/159 fingerprints restored exactly**; post-cleanup crawl **byte-identical**. Hosted record unchanged: migrations **109** · business **`6abe424f43bff901`** · world **`c299c6e372c686c4`** · security **`569e5497a7622048`** · **31/0**. Permanent Preview `controlPlane` remained **OFF**; sending **0/0/0/0/0**. **CFR-1.2 adopted** (clock-derived comparison rule) and the crawl re-baselined. **Slice 2 NOT STARTED.** *(Earlier entries below are a dated historical log; where they say an item is OPEN, that was true on that date and has since been superseded.)*

**2026-09-16 (latest) — P45-1: HOSTED ACCEPTED / CLOSED. P45-D1: HOSTED CORRECTED / CLOSED.**
