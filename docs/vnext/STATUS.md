...
**Last updated:** 2026-09-15 (H1B Gate 5 — branch Preview runtime switched to `app_rw`, PASS; Gate 6 not begun)

**2026-09-15 (latest) — H1B GATE 5: PASS.** The normal vNext Preview runtime now runs as **`app_rw`**.
