...
SLICE 2B Pursuit Attention + Today/Queue   (P3)        DEMO CERTIFIED / FROZEN
   ...
   ↓
H1  PRE-PILOT HARDENING GATE               (P6 / #67)  H1A · GATE 1 · H1B-0 · GATE 1b PASS · GATE 2 BLOCKED · H1B-0.1 LOCAL  ← current
   ...
   │      on 31 authorization-sensitive functions (D-050); local only, hosted is Gate 1b.1
