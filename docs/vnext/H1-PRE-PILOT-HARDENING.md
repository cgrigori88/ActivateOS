...
**Gate 9 was NOT begun.** H1B and H1 are not complete. **D-P1 remains OPEN** (`/pipeline?timeframe=` can overwrite the canonical daily snapshot). It must be fixed before Gate 9 / a real pilot.
